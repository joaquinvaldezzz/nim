      ...
      <motion.section variants={VARIANTS_SECTION} transition={TRANSITION_SECTION}>
        <div className="flex-1">
          <p className="text-zinc-600 dark:text-zinc-400">
            I value agile methods, transparency, and strong collaboration with teammates.
          </p>
        </div>
      </motion.section>
          ...
          {WORK_EXPERIENCE.map((job) => (
            ...
            >
              <Spotlight
                ...
                size={64}
              />
              <div className="relative h-full w-full rounded-2xl bg-white p-4 dark:bg-zinc-950">
